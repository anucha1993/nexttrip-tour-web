...
<section class="mx-auto max-w-7xl px-4 md:px-8 py-12">
  ...
  <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
    ...
    <figure class="overflow-hidden rounded-2xl ring-1 ring-black/5 shadow">
         <a href="/404">
      <img
    ...
    <figure class="lg:col-span-2 overflow-hidden rounded-2xl ring-1 ring-black/5 shadow">
         <a href="/404">
      <img
        src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=1600&auto=format&fit=crop#2"
...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
          ...
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-orange-500 dark:text-white">เลือกทัวร์ที่ใช่ในสไตล์คุณ</h2>
<p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
    ให้เราช่วยคุณค้นหาแพ็คเกจทัวร์ที่ตรงใจ ไม่ว่าจะเป็นทัวร์แบบครอบครัว ทัวร์สำหรับคู่รัก 
    ทัวร์กรุ๊ปเพื่อน หรือทัวร์ส่วนตัว เรามีตัวเลือกที่หลากหลายให้คุณได้เลือกสรร พร้อมปรับแต่งแพ็คเกจให้เข้ากับความต้องการของคุณ
</p>
      </div> 
