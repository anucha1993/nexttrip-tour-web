...
<head>
    ...
    <link rel="manifest" href="/manifest.json">
            <!-- 5 stars example (4.8) -->
            <svg class="w-5 h-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.802 2.036a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118L10 13.347l-2.985 2.126c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L3.38 8.719c-.783-.57-.38-1.81.588-1.81h3.462a1 1 0 00.95-.69l1.07-3.292z"/></svg>
            <svg class="w-5 h-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.802 2.036a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118L10 13.347l-2.985 2.126c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L3.38 8.719c-.783-.57-.38-1.81.588-1.81h3.462a1 1 0 00.95-.69l1.07-3.292z"/></svg>
            <svg class="w-5 h-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.802 2.036a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118L10 13.347l-2.985 2.126c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L3.38 8.719c-.783-.57-.38-1.81.588-1.81h3.462a1 1 0 00.95-.69l1.07-3.292z"/></svg>
            <svg class="w-5 h-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.802 2.036a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118L10 13.347l-2.985 2.126c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L3.38 8.719c-.783-.57-.38-1.81.588-1.81h3.462a1 1 0 00.95-.69l1.07-3.292z"/></svg>
            <svg class="w-5 h-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.802 2.036a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118L10 13.347l-2.985 2.126c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L3.38 8.719c-.783-.57-.38-1.81.588-1.81h3.462a1 1 0 00.95-.69l1.07-3.292z"/></svg>itle>NextTrip Tour - จองแพ็คเกจทัวร์ออนไลน์</title>
    ...
    <div id="default-carousel" class="relative w-full mx-auto max-w-screen-xl " data-carousel="slide">
        ...
        <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
            ...
            <div class="hidden duration-500 ease-in-out" data-carousel-item>
                <img src="https://plus.unsplash.com/premium_photo-1661878091370-4ccb8763756a?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
            </div>
            <!-- Item 2 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="https://plus.unsplash.com/premium_photo-1661962892760-5e50359c5123?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
            </div>
...
<section class="mx-auto max-w-7xl px-4 md:px-8 py-12">
  ...
  <header class="text-center max-w-3xl mx-auto">
    <h2 class="text-3xl md:text-4xl font-extrabold tracking-tight text-orange-500">
      ประเทศยอดนิยม
    </h2>
    <p class="mt-3 text-slate-600">
      ค้นพบประสบการณ์การท่องเที่ยวที่น่าจดจำกับแพ็คเกจทัวร์ยอดนิยมของเรา ไม่ว่าจะเป็นญี่ปุ่นที่เต็มไปด้วยวัฒนธรรมอันงดงาม 
      เกาหลีกับแหล่งช้อปปิ้งสุดทันสมัย ไต้หวันกับอาหารสตรีทฟู้ดชื่อดัง หรือเวียดนามที่เต็มไปด้วยมนต์เสน่ห์แห่งอินโดจีน 
      พร้อมให้คุณออกเดินทางกับเรา ในราคาที่คุ้มค่า บริการที่ประทับใจ
    </p>
  </header>
  ...
  <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
    ...
    <figure class="relative overflow-hidden rounded-2xl ring-1 ring-black/5 shadow group">
      <a href="/404">
        <img
          src="https://nexttripholiday.com/upload/country/image_banner03022025-22152302.jpeg"
          alt="ทัวร์ญี่ปุ่น"
    ...
    <figure class="relative overflow-hidden rounded-2xl ring-1 ring-black/5 shadow group">
      <a href="/404">
        <img
          src="https://nexttripholiday.com/upload/country/image_banner03022025-21535202.jpeg"
          alt="ทัวร์เกาหลี"
          class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-[1.05]"
          style="aspect-ratio:16/10"
          loading="lazy" decoding="async">
    ...
    <figure class="relative overflow-hidden rounded-2xl ring-1 ring-black/5 shadow group">
      <a href="/404">
        <img
          src="https://nexttripholiday.com/upload/country/image_banner03022025-22060802.jpeg"
          alt="ทัวร์ไต้หวัน"
          class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-[1.05]"
          style="aspect-ratio:16/10"
          loading="lazy" decoding="async">
    ...
    <figure class="relative overflow-hidden rounded-2xl ring-1 ring-black/5 shadow group">
      <a href="/404">
        <img
          src="https://images.unsplash.com/photo-1517263904808-5dc91e3e7044?q=80&w=900&auto=format&fit=crop"
          alt="ทัวร์เวียดนาม"
          class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-[1.05]"
          style="aspect-ratio:16/10"
          loading="lazy" decoding="async">
    ...
    <!-- 5 (wide) -->
    <figure class="relative lg:col-span-2 overflow-hidden rounded-2xl ring-1 ring-black/5 shadow group">
      <a href="/404">
        <img
          src="https://nexttripholiday.com/upload/country/image_banner03022025-22534902.jpeg"
          alt="ทัวร์ฝรั่งเศส"
          class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-[1.05]"
...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
    ...
    <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
      <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-orange-500 dark:text-white">
        เลือกทัวร์ที่ใช่ในสไตล์คุณ
      </h2>
      <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
        เรารวบรวมแพ็กเกจทัวร์ยอดนิยมทั้งในและต่างประเทศ
        ไม่ว่าจะเป็นทัวร์ครอบครัว คู่รัก เพื่อนฝูง หรือทัวร์ส่วนตัว
        พร้อมสิทธิพิเศษและราคาที่คุ้มค่า
      </p>
    </div>
    ...
    <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
      ...
      <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
          <img class="w-full h-56 object-cover rounded-lg sm:rounded-none sm:rounded-l-lg" 
               src="https://nexttripholiday.com/upload/country/image_banner10112023-15012411.jpeg" 
               alt="ทัวร์ญี่ปุ่น ซากุระ">
        </a>
        <div class="p-5">
          <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
            <a href="#">ทัวร์ญี่ปุ่น ชมซากุระ 6 วัน 4 คืน</a>
          </h3>
          <span class="block text-orange-500 font-semibold mt-1">เริ่มต้น 39,900 บาท</span>
          <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
            เดินทางสู่โตเกียว เกียวโต โอซาก้า ชมซากุระบานเต็มที่
            พร้อมสัมผัสวัฒนธรรมญี่ปุ่นและลิ้มรสอาหารท้องถิ่น
          </p>
          <a href="#"
             class="inline-block px-4 py-2 text-sm font-medium text-white bg-orange-500 rounded-lg hover:bg-orange-600">
            ดูรายละเอียด
          </a>
        </div>
      </div>
      ...
      <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
          <img class="w-full h-56 object-cover rounded-lg sm:rounded-none sm:rounded-l-lg" 
               src="https://images.unsplash.com/photo-1527668752968-14dc70a27c95?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
               alt="ทัวร์ยุโรป">
        </a>
        <div class="p-5">
          <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
            <a href="#">ทัวร์ยุโรป ฝรั่งเศส-สวิตเซอร์แลนด์-อิตาลี 10 วัน</a>
          </h3>
          <span class="block text-orange-500 font-semibold mt-1">เริ่มต้น 89,900 บาท</span>
          <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
            สัมผัสเสน่ห์เมืองยุโรป ชมวิวเทือกเขาแอลป์ เดินเล่นปารีส
            และชิมอาหารอิตาเลียนต้นตำรับ
          </p>
          <a href="#"
             class="inline-block px-4 py-2 text-sm font-medium text-white bg-orange-500 rounded-lg hover:bg-orange-600">
            ดูรายละเอียด
      ...
      <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
          <img class="w-full h-56 object-cover rounded-lg sm:rounded-none sm:rounded-l-lg" 
               src="https://images.unsplash.com/photo-1573843981267-be1999ff37cd?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
               alt="ทัวร์มัลดีฟส์">
        </a>
        <div class="p-5">
          <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
            <a href="#">ทัวร์มัลดีฟส์ พักวิลล่าเหนือน้ำ 5 วัน 3 คืน</a>
          </h3>
          <span class="block text-orange-500 font-semibold mt-1">เริ่มต้น 55,900 บาท</span>
          <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
            ดื่มด่ำกับน้ำทะเลใสสีฟ้า พักผ่อนในวิลล่าเหนือผิวน้ำ
            พร้อมกิจกรรมดำน้ำและสปาหรู
          </p>
          <a href="#"
             class="inline-block px-4 py-2 text-sm font-medium text-white bg-orange-500 rounded-lg hover:bg-orange-600">
            ดูรายละเอียด
      ...
      <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
        <a href="#">
          <img class="w-full h-56 object-cover rounded-lg sm:rounded-none sm:rounded-l-lg" 
               src="https://plus.unsplash.com/premium_photo-1724458589661-a2f42eb58aca?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
               alt="ทัวร์เกาหลี">
        </a>
        <div class="p-5">
          <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
            <a href="#">ทัวร์เกาหลี โซล-พาซู-เกาะนามิ 5 วัน 3 คืน</a>
          </h3>
          <span class="block text-orange-500 font-semibold mt-1">เริ่มต้น 29,900 บาท</span>
          <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
            ชมใบไม้เปลี่ยนสี เดินเล่นถนนช้อปปิ้งเมียงดง
            และเพลิดเพลินกับอาหารเกาหลีหลากหลายเมนู
          </p>
          <a href="#"
             class="inline-block px-4 py-2 text-sm font-medium text-white bg-orange-500 rounded-lg hover:bg-orange-600">
            ดูรายละเอียด
...
<section class="bg-white dark:bg-gray-900">
    <div class="flex justify-center items-center py-3">
        <button type="button" class="text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
            ดูทัวร์ทั้งหมด
        </button>
    </div>
</section>
...
<section class="mx-auto max-w-7xl px-4 md:px-6 py-12">
  <!-- Heading -->
  <div class="text-center max-w-3xl mx-auto">
    <h2 class="text-3xl md:text-4xl font-extrabold tracking-tight text-orange-500">
      รีวิวทัวร์จากลูกค้าของเรา
    </h2>
    <p class="mt-3 text-slate-600">
      เสียงจริงจากผู้เดินทาง—ช่วยให้คุณตัดสินใจทริปถัดไปได้ง่ายขึ้น
    </p>
  </div>
  ...
  <div class="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-6">
    <!-- Card 1 -->
    <article class="rounded-2xl border border-slate-200 bg-white shadow-sm hover:shadow-md transition-shadow">
      <!-- Cover -->
      <div class="p-4 pb-0">
        <img
          src="https://images.unsplash.com/photo-1526772662000-3f88f10405ff?q=80&w=1200&auto=format&fit=crop"
          alt="Japan Autumn Tour"
          width="1200" height="700"
          class="w-full rounded-xl object-cover"
          style="aspect-ratio: 16/9;" loading="lazy" decoding="async">
      </div>

      <!-- Content -->
      <div class="p-4 md:p-6">
        <!-- Top row: rating + donors-like meta -->
        <div class="flex items-center justify-between">
          <!-- rating stars (Flowbite icons style) -->
          <div class="flex items-center">
            <!-- 5 stars example (4.8) -->
            <svg class="w-5 h-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.802 2.036a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118L10 13.347l-2.985 2.126c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L3.38 8.719c-.783-.57-.38-1.81.588-1.81h3.462a1 1 0 00.95-.69l1.07-3.292z"/></svg>
            <svg class="w-5 h-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"><path d="M9.049 2.927c..."/></svg>
            <svg class="w-5 h-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"><path d="M9.049 2.927c..."/></svg>
            <svg class="w-5 h-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"><path d="M9.049 2.927c..."/></svg>
            <svg class="w-5 h-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true"><path d="M9.049 2.927c..."/></svg>
            <span class="ml-2 text-sm font-medium text-slate-700">4.8</span>
            <span class="mx-2 text-slate-300">•</span>
            <span class="text-sm text-slate-500">รีวิว 268 รายการ</span>
          </div>

          <!-- trip length / date -->
          <div class="text-xs text-slate-500">
            6 วัน 4 คืน · พ.ย. 2024
          </div>
        </div>

        <!-- Title -->
        <h3 class="mt-3 text-lg md:text-xl font-semibold text-slate-900">
          ญี่ปุ่นใบไม้เปลี่ยนสี โอซาก้า–เกียวโต
        </h3>

        <!-- Review text -->
        <p class="mt-2 text-slate-600">
          ไกด์ดูแลดีมาก โปรแกรมไม่อัดแน่น รถสะอาด เวลาเป๊ะ อาหารโอซาก้าดีงาม โดยรวมประทับใจสุด ๆ
          ใครอยากชมใบไม้แดงแบบไม่วุ่นวาย แนะนำรอบเช้าในอาราชิยามะเลยครับ
        </p>

        <!-- Reviewer -->
        <div class="mt-4 flex items-center gap-3">
          <img src="https://i.pravatar.cc/64?img=12" alt="Reviewer" class="h-10 w-10 rounded-full object-cover">
          <div>
            <div class="text-sm font-semibold text-slate-900">คุณภาคิน</div>
            <div class="text-xs text-slate-500">เดินทางกับ Next Trip Holiday</div>
          </div>
        </div>

        <!-- Tags -->
        <div class="mt-4 flex flex-wrap gap-2">
          <span class="inline-flex items-center rounded-full bg-blue-50 text-blue-700 text-xs font-medium px-3 py-1">ครอบครัว</span>
          <span class="inline-flex items-center rounded-full bg-emerald-50 text-emerald-700 text-xs font-medium px-3 py-1">บริการดี</span>
          <span class="inline-flex items-center rounded-full bg-amber-50 text-amber-700 text-xs font-medium px-3 py-1">คุ้มค่า</span>
        </div>

        <!-- Actions -->
        <div class="mt-5 flex flex-wrap gap-3">
          <a href="#"
             class="inline-flex items-center gap-2 rounded-lg bg-orange-500 px-4 py-2 text-white text-sm font-semibold hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400">
            ดูรีวิวเต็ม
          </a>

          <!-- Share (ใช้ data-dropdown-toggle ของ Flowbite) -->
          {{-- <button type="button" data-dropdown-toggle="share-dd-1"
          ...
          <div id="share-dd-1" class="z-20 hidden w-44 rounded-lg border border-slate-200 bg-white p-2 shadow-md">
            <a href="#" class="block rounded px-3 py-2 text-sm hover:bg-slate-50">Facebook</a>
            <a href="#" class="block rounded px-3 py-2 text-sm hover:bg-slate-50">LINE</a>
            <a href="#" class="block rounded px-3 py-2 text-sm hover:bg-slate-50">คัดลอกลิงก์</a>
          </div>
        </div>
      </div>
    </article>
      ...
      <div class="p-4 md:p-6">
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            ...
            <svg class="w-5 h-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"><path d="M9.049 2.927c..."/></svg>
            <svg class="w-5 h-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor"><path d="M9.049 2.927c..."/></svg>
            <svg class="w-5 h-5 text-yellow-400/60" viewBox="0 0 20 20" fill="currentColor"><path d="M9.049 2.927c..."/></svg>
            <span class="ml-2 text-sm font-medium text-slate-700">4.6</span>
            <span class="mx-2 text-slate-300">•</span>
            <span class="text-sm text-slate-500">รีวิว 112 รายการ</span>
          </div>
          <div class="text-xs text-slate-500">8 วัน 5 คืน · ต.ค. 2024</div>
        </div>

        <h3 class="mt-3 text-lg md:text-xl font-semibold text-slate-900">
          สวิสเซอร์แลนด์ พาโนรามิก กลาเซียร์เอ็กซ์เพรส
        </h3>

        <p class="mt-2 text-slate-600">
          รถไฟวิวอลังการจริง ๆ โรงแรมดี ทำเลดี ทุกอย่างราบรื่น ไกด์ให้เวลาเต็มอิ่มถ่ายรูปและขึ้นยอดเขา ทริปในฝันสมชื่อ!
        </p>

        <div class="mt-4 flex items-center gap-3">
          <img src="https://i.pravatar.cc/64?img=32" alt="Reviewer" class="h-10 w-10 rounded-full object-cover">
          <div>
            <div class="text-sm font-semibold text-slate-900">คุณศิริพร</div>
            <div class="text-xs text-slate-500">ลูกค้าประจำ Next Trip Holiday</div>
          </div>
        </div>

        <div class="mt-4 flex flex-wrap gap-2">
          <span class="inline-flex items-center rounded-full bg-fuchsia-50 text-fuchsia-700 text-xs font-medium px-3 py-1">วิวสวย</span>
          <span class="inline-flex items-center rounded-full bg-sky-50 text-sky-700 text-xs font-medium px-3 py-1">รถไฟพาโนรามา</span>
          <span class="inline-flex items-center rounded-full bg-emerald-50 text-emerald-700 text-xs font-medium px-3 py-1">บริการดี</span>
        </div>

        <div class="mt-5 flex flex-wrap gap-3">
          <a href="#" class="inline-flex items-center gap-2 rounded-lg bg-orange-500 px-4 py-2 text-white text-sm font-semibold hover:bg-blue-500">
            ดูรีวิวเต็ม
          </a>
          {{-- <button type="button" data-dropdown-toggle="share-dd-2"
            class="inline-flex items-center gap-2 rounded-lg border border-slate-300 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
            แชร์รีวิวนี้
          </button> --}}
          <div id="share-dd-2" class="z-20 hidden w-44 rounded-lg border border-slate-200 bg-white p-2 shadow-md">
            <a href="#" class="block rounded px-3 py-2 text-sm hover:bg-slate-50">Facebook</a>
            <a href="#" class="block rounded px-3 py-2 text-sm hover:bg-slate-50">LINE</a>
            <a href="#" class="block rounded px-3 py-2 text-sm hover:bg-slate-50">คัดลอกลิงก์</a>
          </div>
...
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
        <h2 class="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-orange-500 dark:text-white md:text-4xl">ลูกค้าที่ไว้วางใจเรา Next Trip Holiday</h2>
...
<section class="mx-auto max-w-7xl px-4 md:px-6 py-12">
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
    ...
    <div class="order-1 lg:order-none">
      <img
        src="https://media.istockphoto.com/id/2060181707/th/%E0%B8%A3%E0%B8%B9%E0%B8%9B%E0%B8%96%E0%B9%88%E0%B8%B2%E0%B8%A2/%E0%B8%99%E0%B8%B1%E0%B8%81%E0%B8%97%E0%B9%88%E0%B8%AD%E0%B8%87%E0%B9%80%E0%B8%97%E0%B8%B5%E0%B9%88%E0%B8%A2%E0%B8%A7%E0%B8%AA%E0%B8%B2%E0%B8%A7%E0%B9%80%E0%B8%94%E0%B8%B4%E0%B8%99%E0%B8%97%E0%B8%B5%E0%B9%88%E0%B8%96%E0%B8%99%E0%B8%99%E0%B9%82%E0%B8%9A%E0%B8%A3%E0%B8%B2%E0%B8%93%E0%B8%88%E0%B8%B4%E0%B8%99%E0%B8%A5%E0%B8%B5%E0%B9%88%E0%B9%83%E0%B8%99%E0%B9%80%E0%B8%89%E0%B8%B4%E0%B8%87%E0%B8%95%E0%B8%B9%E0%B8%9B%E0%B8%A3%E0%B8%B0%E0%B9%80%E0%B8%97%E0%B8%A8%E0%B8%88%E0%B8%B5%E0%B8%99.jpg?s=2048x2048&w=is&k=20&c=fF1pCUXRETuYnAkbvzUzi77VuBnv_PsnOz-WKMgpk-4="
        alt="Next Trip Holiday team and travelers"
        width="1600" height="1066"
        class="w-full rounded-2xl object-cover ring-1 ring-black/5 shadow"
        style="aspect-ratio: 16/10;" loading="lazy" decoding="async">
    </div>

    <!-- Content -->
    <div>
      <h3 class="text-lg md:text-4xl font-extrabold tracking-tight text-orange-500">
        เที่ยวครบจบที่ เน็กซ์ ทริป ฮอลิเดย์ — ทัวร์คุณภาพ
      </h3>
      <p class="mt-3 text-slate-600">
        เราบริการทัวร์คุณภาพมากมาย เพื่อให้ลูกค้าประทับใจในทุกทริป
      </p>
      ...
      <ul class="space-y-6">
        <!-- Item 1 -->
        <li class="flex gap-4">
          <span class="mt-1 inline-flex h-9 w-9 flex-none items-center justify-center rounded-full bg-blue-50 text-blue-600 ring-1 ring-inset ring-blue-100">
            <!-- lock icon style -->
            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M12 1.75a4.75 4.75 0 00-4.75 4.75v2.25H6a2.25 2.25 0 00-2.25 2.25v7.5A2.25 2.25 0 006 20.75h12a2.25 2.25 0 002.25-2.25v-7.5A2.25 2.25 0 0018 8.75h-.75V6.5A4.75 4.75 0 0012 1.75zm-3.25 4.75A3.25 3.25 0 0112 3.25a3.25 3.25 0 013.25 3.25v2.25h-6.5V6.5z"></path></svg>
          </span>
          <div>
            <h4 class="text-base font-semibold text-slate-900">เที่ยวครบ คุ้ม</h4>
            <p class="mt-1 text-slate-600">
              บริการทัวร์เที่ยวครบตามโปรแกรม ในราคาที่คุ้มค่า
            </p>
            <a href="/tours" class="mt-2 inline-flex items-center text-sm font-medium text-blue-600 hover:underline">
              ดูแพ็กเกจทัวร์ <svg class="ml-1 h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l5 5a1 1 0 010 1.414l-5 5a1 1 0 11-1.414-1.414L13.586 10H4a1 1 0 110-2h9.586l-3.293-3.293a1 1 0 010-1.414z" clip-rule="evenodd"/></svg>
            </a>
          </div>
        </li>
        ...
        <!-- Item 2 -->
        <li class="flex gap-4">
          <span class="mt-1 inline-flex h-9 w-9 flex-none items-center justify-center rounded-full bg-violet-50 text-violet-600 ring-1 ring-inset ring-violet-100">
            <!-- graph icon -->
            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M4 5.25a.75.75 0 01.75-.75H6a.75.75 0 01.75.75v13.5a.75.75 0 01-.75.75H4.75a.75.75 0 01-.75-.75V5.25zM10.5 10a.75.75 0 01.75-.75h1.25a.75.75 0 01.75.75v8.75a.75.75 0 01-.75.75H11.25a.75.75 0 01-.75-.75V10zM17 6.5a.75.75 0 01.75-.75H19a.75.75 0 01.75.75v12.25a.75.75 0 01-.75.75h-1.25a.75.75 0 01-.75-.75V6.5z"/></svg>
          </span>
          <div>
            <h3 class="text-base font-semibold text-slate-900">เชื่อถือได้</h3>
            <p class="mt-1 text-slate-600">
              ประสบการณ์มากกว่า 15 ปี กับวงการท่องเที่ยว
            </p>
            <a href="/about" class="mt-2 inline-flex items-center text-sm font-medium text-blue-600 hover:underline">
              รู้จักเราเพิ่มเติม <svg class="ml-1 h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l5 5a1 1 0 010 1.414l-5 5a1 1 0 11-1.414-1.414L13.586 10H4a1 1 0 110-2h9.586l-3.293-3.293a1 1 0 010-1.414z" clip-rule="evenodd"/></svg>
            </a>
          </div>
        </li>
        ...
        <!-- Item 3 -->
        <li class="flex gap-4">
          <span class="mt-1 inline-flex h-9 w-9 flex-none items-center justify-center rounded-full bg-emerald-50 text-emerald-600 ring-1 ring-inset ring-emerald-100">
            <!-- code scan icon style -->
            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M4 6a2 2 0 012-2h2v2H6v2H4V6zm12-2h2a2 2 0 012 2v2h-2V6h-2V4zM4 16h2v2h2v2H6a2 2 0 01-2-2v-2zm16 0v2a2 2 0 01-2 2h-2v-2h2v-2h2zM7 11h10v2H7v-2z"/></svg>
          </span>
          <div>
            <h3 class="text-base font-semibold text-slate-900">ส่วนลดพิเศษ</h3>
            <p class="mt-1 text-slate-600">
              ส่วนลดพิเศษสุดคุ้ม ทัวร์อัปเดตทุกวัน
            </p>
            <a href="/deals" class="mt-2 inline-flex items-center text-sm font-medium text-blue-600 hover:underline">
              ดูโปรโมชันวันนี้ <svg class="ml-1 h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l5 5a1 1 0 010 1.414l-5 5a1 1 0 11-1.414-1.414L13.586 10H4a1 1 0 110-2h9.586l-3.293-3.293a1 1 0 010-1.414z" clip-rule="evenodd"/></svg>
            </a>
          </div>
        </li>
      </ul>
      ...
      <p class="text-sm text-slate-500">
        เลือกประสบการณ์การท่องเที่ยวที่ใช่—จองง่าย แผนชัดเจน เดินทางสบาย พร้อมทีมงานดูแลตลอดทริป
      </p>
    </div>
  </div>
</section>
